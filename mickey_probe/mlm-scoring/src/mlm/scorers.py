...
from .models.bert import BERTRegression, AlbertForMaskedLMOptimized, BertForMaskedLMOptimized, DistilBertForMaskedLMOptimized, RobertaForMaskedLMOptimized, XLMRobertaForMaskedLMOptimized
...
- MLMScorerPT supports PyTorch Transformers MLMs:
    ...
    - 'roberta-*' (wrapped by RobertaForMaskedLMOptimized)
            ...
            for ctx_idx, (sent_idxs, token_ids, valid_length, masked_positions, token_masked_ids, normalization) in enumerate((batch,)):
                ...
                with torch.no_grad():
                    ...
                    if isinstance(self._model.module, AlbertForMaskedLMOptimized) or \
                        ...
                        isinstance(self._model.module, DistilBertForMaskedLMOptimized) or \
                        isinstance(self._model.module, RobertaForMaskedLMOptimized) or \
                        isinstance(self._model.module, XLMRobertaForMaskedLMOptimized):
