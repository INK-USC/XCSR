...
# PyTorch-based
from transformers import AlbertForMaskedLM, BertForMaskedLM, DistilBertForMaskedLM, RobertaForMaskedLM, XLMRobertaForMaskedLM
...
class XLMRobertaForMaskedLMOptimized(XLMRobertaForMaskedLM):
