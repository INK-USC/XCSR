...
class DataTrainingArguments:
    ...
    exp_name: str = field(metadata={"help": "The name of the wandb to report on: " + ", ".join(processors.keys())})
...
def main():
    ...
    if data_args.exp_name:
        wandb.init(project="xcsr", name=data_args.exp_name)
    ...
    if training_args.do_predict:
        ...
        os.makedirs(os.path.dirname(data_args.prediction_output), exist_ok=True)
