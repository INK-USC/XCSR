...
if [ "$MODE" = "en_train" ]; then
    ...
    do 
        ...
        if [[ "$active_langs" == *"$lang"* ]]; then
            ...
            MODEL_DIR=/path/to/saved_models_xcodah/xlmrl_${lang}
    ...
    do        
        ...
        do
            DATA_DIR=/path/to/X-CODAH/${lang}
            MODEL_DIR=/path/to/saved_models_xcodah/xlmrl_en
...
# for lang in "${langs[@]}" 
# do        
#     mv /path/to/saved_models_xcodah/xlmrl_${lang} /path/to/saved_models_xcodah/xlmrl_${lang}_backup
# done