...
if [ "$MODE" = "self-train" ]; then
    ...
    do 
        ...
        if [[ "$active_langs" == *"$lang"* ]]; then
            ...
            MODEL_DIR=/mnt/nfs1/bill/saved_models_xcsqa/mbart_${lang}
            CUDA_VISIBLE_DEVICES=4,5,6,7 python methods/run_mcqa.py \
                --task_name xcsr \
                --exp_name "mbart_${lang}|(${lr}-${warm})" \
                ...
                --prediction_output ${DATA_DIR}/results/self_test_mbart_result.npy
        fi 
    done
    ...
    do        
        ...
        do
            ...
            DATA_DIR=corpus/CSQA/X-CSQA/${lang}
            MODEL_DIR=/mnt/nfs1/bill/saved_models_xcsqa/mbart_en
            CUDA_VISIBLE_DEVICES=4 python methods/run_mcqa.py \
                ...
                --fp16 --overwrite_output \
                --overwrite_cache \
                --prediction_output ${DATA_DIR}/results/en-${lang}_${split}_mbart_result.npy
        done
    done
else
    echo "Wrong Mode"
...
# for lang in "${langs[@]}" 
# do        
#     mv /mnt/nfs1/bill/saved_models_xcsqa/mbart_${lang} /mnt/nfs1/bill/saved_models_xcsqa/mbart_${lang}_backup
# done