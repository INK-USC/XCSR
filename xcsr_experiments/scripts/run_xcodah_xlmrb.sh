...
if [ "$MODE" = "self-train" ]; then
    ...
    do 
        ...
        if [[ "$active_langs" == *"$lang"* ]]; then
            ...
            MODEL_DIR=/mnt/nfs1/bill/saved_models_xcodah/xlmrb_${lang}
    ...
    do        
        ...
        do
            DATA_DIR=corpus/CODAH/X-CODAH/${lang}
            MODEL_DIR=/mnt/nfs1/bill/saved_models_xcodah/xlmrb_en
...
# for lang in "${langs[@]}" 
# do        
#     mv /mnt/nfs1/bill/saved_models_xcodah/xlmrb_${lang} /mnt/nfs1/bill/saved_models_xcodah/xlmrb_${lang}_backup
# done